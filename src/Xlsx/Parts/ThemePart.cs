...
/// <summary>Generates xl/theme/theme1.xml — the standard Office default theme.</summary>
internal static class XlsxThemePart
{
    public static byte[] Generate() =>
        System.Text.Encoding.UTF8.GetBytes(ThemeXml);
    ...
    private const string ThemeXml =
        ...
        "<themeFamily xmlns=\"http://schemas.microsoft.com/office/2012/main\" name=\"Office Theme\" id=\"{62F939B6-93AF-4DB8-9C6B-D6C7DFDC589F}\" vid=\"{4A3C46E8-61CC-4603-A589-7422A47A8E4A}\"/>" +
        "</a:ext></a:extLst>" +
        "</a:theme>";
}
